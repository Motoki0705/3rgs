...
- `fit_from_ground_heatmap.py`
  ...
  chunk 単位の fit と clustering を行い、`init_sim3.json` 形式の初期値を出力します。
...
- dominant cluster での再 fit が全体 fit より悪い場合は、自動で全体 fit にフォールバックします。
